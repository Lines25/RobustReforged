...
# WARNING
## THIS PROJECT HAS NOTHING TO DO WITH OFFICIAL RobustToolbox !!!

## DON'T MAKE PRs ON THEIR REPO !! USE THIS REPO INSTEAD !!

Also, if you have error like `"libreforged.so" failed to load: No such file or directory` - then just add compiled reforged.so or reforged.dll to your server directory alongside `Robust.Server` executable

# WARNING

# Info about RobustReforged

### This project aimed to speed up and track space-station-14 (may work on RMC-14, not tested tho) servers speed. Currently, the version of Reforged patches: *v0.1P*
